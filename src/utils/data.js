export const dataJson = [
  ...
  {
    topic:
      '在数据模型中，可以新建目录来存放字段，且该目录下的字段拥有层次结构。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '在数据模型中可以对度量字段以及计算度量字段修改数据格式。 (1.0分)',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic:
      '数据的展示表达中，从数据的展示效果以及表达信息的清晰度比较，图形优于表格，表格优于文字。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic:
      'Web电子表格数据设置中，哪个设置项可以将数据列中相同内容的值进行合并？',
    answer: 'D',
  ...
  {
    topic:
      '交互式仪表盘中已经制作好的图表，如果想要换一种图表类型的话，应该怎么做？',
    answer: 'C',
    answer_arr: [
  ...
  {
    topic:
      '交互式仪表盘中通过标线实现对图形数据实现预警效果，以下描述正确的是？',
    answer: 'A',
    answer_arr: [
  ...
  {
    topic:
      '透视分析想要实现时间计算，必须保证行区/列区/过滤条件区中有什么字段？',
    answer: 'B',
    answer_arr: [
      'A. 普通维度字段',
      'B. 时间维度字段',
  ...
  {
    topic:
      '想要标识出客户的不同阶段，可以制定不同的营销活动，如新产品推广、优惠券和促销活动等，可以使用哪个分析模型？',
    answer: 'B',
    answer_arr: [
      'A. 购物篮分析模型',
      'B. 客户生命周期模型',
  ...
  {
    topic:
      '想要将本地的数据文件导入到数据库中，Smartbi具体支持接入的数据库有哪些？',
    answer: 'AD',
    answer_arr: [
      'A. 关系数据库（RDBMS）',
      'B. 多维数据库（OLAP)',
  ...
  {
    topic:
      '为了让数据查询有更多的灵活性，即席查询支持在数据模型和数据源中自定义维度，包含？',
    answer: 'BC',
    answer_arr: [
      'A. 新建命名集',
      'B. 新建计算列',
  ...
  {
    topic: '交互式仪表盘的表格组件可以实现的条件格式有哪几种？ ',
    answer: 'ABC',
  ...
  {
    topic: 'Web电子表格支持单元格数据过滤。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '杜邦分析模型可以帮助企业识别影响其绩效的主要财务因素。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '占比构成、多类别部分到整体、成分分布构成等属于图形选择决策树中构成系列的图形特性。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic:
      '某技术人员习惯写SQL取数，在数据模型中可以使用什么子查询进行模型的构建？',
    answer: 'D',
    answer_arr: [
      'A. 可视化SQL查询',
      'B. 数据源表',
  ...
  {
    topic:
      '哪个选项用于对交互式仪表盘中所有组件的样式批量进行设计，包括背景、边框、标题。',
    answer: 'B',
    answer_arr: [
      'A. 主题区仪表盘',
      'B. 主题区组件',
  ...
  {
    topic:
      '用户拿到一张炫酷的仪表盘演示模板，想要将数据替换成自己的业务数据查看效果，可以通过哪个功能完成',
    answer: 'D',
  ...
  {
    topic:
      '某用户有中国式复杂报表的需求，但公司内部要求严格，无法在机器上安装外部插件，可推荐Smartbi的什么功能模块给此用户实现他的需求？',
    answer: 'B',
    answer_arr: [
      'A. 电子表格',
      'B. Web电子表格',
  ...
  {
    topic:
      '交互式仪表盘的布局工具包括哪些功能，实现大屏精准排布，组件快速定位。',
    answer: 'ABCD',
    answer_arr: [
      'A. 鹰眼、画布缩放',
      'B. 参考线、网格线、智能参考线',
  ...
  {
    topic:
      '在透视分析中，可以对过滤的结果数据，作进一步筛选过滤，这种过滤的方式有哪些？',
    answer: 'AC',
  ...
  {
    topic:
      '统计学是一门通过收集、处理、分析、解释数据并从数据中得出结论的科学。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '在RFM模型中，最近一次购买日期越远的客户一般被认为？ ',
    answer: 'C',
  ...
  {
    topic:
      '数据分析微观方法中，分析时可以按类型、结构、时间阶段等维度进行分组，观察分组后的数据特征，从特征中洞察信息，属于什么分析方法',
    answer: 'D',
  ...
  {
    topic:
      'RFM模型通过分析顾客的最近购买时间、购买频率和购买金额来进行客户分类。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic:
      '将有一定关联的两个或两个以上的维度和度量值排列在统计表内进行对比分析，在小于等于三维的情况下可以灵活使用图表进行展示。当维度大于三维时选用统计表展示，此称之为什么分析方法。',
    answer: 'C',
    answer_arr: ['A. 增维法', 'B. 降维法', 'C. 交叉法', 'D. 分组法'],
    type: 'radio',
  },
  ...
  {
    topic: '如果柱图的柱子数量太多，可以使用什么方式提高图形的可看性？',
    answer: 'ABC',
    answer_arr: [
      'A. 增加缩略轴',
      'B. 设置排序并减少输出行数',
