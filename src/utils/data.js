export const dataJson = [
  ...
  {
    topic:
      '[align=left][font=思源黑体Normal]查询明细数据是最为常见的业务需求，业务人员一般可以使用[/font]Smartbi[font=思源黑体Normal]平台哪项功能？[/font][/align]',
    answer: 'A',
    answer_arr: [
      'A. 即席查询',
      'B. 透视分析',
  ...
  {
    topic: '数据分析微观方法中，通过TOPN找到分析的重点的分析方法是？ (2.0分)',
    answer: 'A',
    answer_arr: ['A. 排序法', 'B. 增维法', 'C. 降维法', 'D. 分组法'],
    type: 'radio',
  },
  ...
  {
    topic: '创建表关系视图时，两表之间可以存在多个字段关联',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '电子表格通过条件格式可以设置告警方式，支持设置数据条以及图标集等。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '关系数据源表属性管理只能修改表别名和字段别名',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '电子表格不支持使用跑马灯控件，因为会影响报表的展示效率。 ',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '电子表格拖拽字段到表格上后，字段的左父格和上父格都默认为“无”。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic:
      '电子表格支持使用Excel条件格式的功能，实现数据的阈值告警，比如设置大于5000的销售额高亮显示。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic:
      '电子表格不仅支持普通的四则运算，还支持复杂计算，如同期值、同期比的计算。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '电子表格自带的函数不可以与Eexcel自带的公式结合使用，两者无法互相融合。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '电子表格中的Tab页控件可以达到在同一sheet页中查看多张报表或者图形的效果',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '电子表格不支持在界面设置只显示结果集前N条数据。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic:
      '电子表格制作echarts图形可以不在单元格拖拽字段，可以直接在对应数据集选择插入图形',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '关系数据源中的表关系视图如果按别名自动建关系，默认的关系都是内连接。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic:
      '制作填报报表的前提是数据库中需要有一张可以进行补录的表，且该表拥有本次补录的所有字段。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '通过数据连接的功能连接到拥有这张补录表的数据库即可，不需要将该表添加到Smartbi平台中也可以进行使用。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '填报报表只能进行数据补录，不能进行数据修改或删除。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '在开发报表前，需要根据业务需求的数据要求，整理出口径不清晰的与财务会计进行沟通并确认口径。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '连接到数据之后可以直接拿数据源表的数据进行制作报表。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '报表导出成 Excel后数值显示成科学计数法是受Smartbi的影响。 ',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic:
      '通常在遇到报表慢或者系统的一些问题时，需要记录前后端通信等信息进行跟踪处理，可以通过什么日志获取到相关信息？',
    answer: 'A',
  ...
  {
    topic: '使用原生SQL数据集的话，可以不用定义数据源的表关系视图',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '系统支持Oracle、Teradata、MySQL等数据库表和字段的注释作为别名',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '电子表格中的清单报表不能自定义每页显示多少行数据，分组报表可以自定义。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '电子表格支持插入显示图片，也支持从数据库读取图片数据。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '原生SQL数据集不支持“select * from”的语句，而SQL数据集支持 ',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '电子表格设置表间跳转时，不支持设置传递参数值。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '电子表格可以通过参数排版的功能，调整电子表格参数的显示位置。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '电子表格支持关联多个参数，但是不支持自定义参数排版。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic:
      '某个电子表格报表引用了多个数据集字段，需要快速知道某个字段来源于哪个数据集，并定位到该数据集上时，可以使用以下哪个功能？',
    answer: 'B',
    answer_arr: [
      'A. 单元格属性',
      'B. 定位数据集',
  ...
  {
    topic:
      '[color=#34495e][font="]业务人员不懂技术，但又需要从清单数据中筛选出报表所需的汇总数据结果，可以使用什么数据集来快速实现？[/font][/color]',
    answer: 'B',
    answer_arr: [
      'A. 即席查询数据集',
      'B. 透视分析数据集',
  ...
  {
    topic: '在电子表格中拖拽一个字段到表格上，默认的扩展方向是？',
    answer: 'B',
  ...
  {
    topic: '电子表格支持数据填报功能，但回写不支持设置自增处理。 ',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '电子表格可以通过传值功能，实现在同一sheet页中的图表联动。 ',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '电子表格支持使用各种控件，下方哪种控件可以实现打开外部网页? ',
    answer: 'D',
  ...
  {
    topic:
      '电子表格支持回写填报数据，某用户配置了回写之后，在预览报表的时候发现工具栏没有保存按钮，有可能是缺少了哪一步配置？',
    answer: 'D',
    answer_arr: [
      'A. 没设置填报属性',
      'B. 回写表没映射到系统',
  ...
  {
    topic: '电子表格支持制作多sheet页报表，以下说法正确的是？ ',
    answer: 'A',
    answer_arr: [
      'A. 可以统一修改所有sheet页标签的背景颜色',
      'B. 不能跨sheet页进行计算公式的取数',
      'C. 不能隐藏sheet页标签，必须显示全部sheet页标签',
      'D. 可以隐藏sheet页标签，但至少显示2个sheet页标签',
    ],
    type: 'radio',
  },
  {
  ...
  {
    topic: '电子表格数据设置中，哪个设置项可以将数据列中相同内容的值进行合并？',
    answer: 'A',
    answer_arr: ['A. 分组', 'B. 列表', 'C. 汇总', 'D. 合并'],
    type: 'radio',
  },
  {
    topic: '关于电子表格，以下说法正确的是？ ',
    answer: 'D',
    answer_arr: [
      'A. 电子表格支持点击列头动态排序',
      'B. 电子表格支持设置维内固定升序',
  ...
  {
    topic: '电子表格设计器中，关于回写的设置选项不包含以下哪一项？ ',
    answer: 'D',
  ...
  {
    topic:
      '管理员想要知道用户在平台中做了什么操作，可以通过什么日志获取到相关信息？',
    answer: 'C',
    answer_arr: ['A. 用户日志', 'B. 系统日志', 'C. 操作日志', 'D. 服务器日志'],
    type: 'radio',
  },
  ...
  {
    topic: '电子表格在设置单元格的填报属性时，可以设置的类型有以下哪些？ ',
    answer: 'ABCD',
    answer_arr: ['A. 数字', 'B. 单行文本', 'C. 日期', 'D. 参数'],
    type: 'radio',
  },
  {
  ...
  {
    topic: '以下哪些是电子表格提供的控件类型？ ',
    answer: 'ABCD',
    answer_arr: ['A. 滑动条', 'B. 单选框', 'C. 跑马灯', 'D. tab页'],
    type: 'radio',
  },
  {
  ...
  {
    topic: '电子表格支持对报表进行间隔色的设置，该功能是通过条件格式实现的。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic:
      '电子表格的公式包含了Excel公式和电子表格公式，并且两者可以结合使用，如应用到前期值、环比的计算。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '业务主题我们可以看作是Smartbi产品中的数据仓库',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '报表导出成Excel后数值显示成科学计数法是受Smartbi的影响。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  ...
  },
  {
    topic:
      '某个电子表格报表引用了多个数据集字段，需要快速知道某个字段来源于哪个数据集，并定位到该数据集上时，可以使用以下哪个功能？',
    answer: 'B',
    answer_arr: ['A.单元格属性', 'B.定位数据集', 'C.页面设置', 'D.字段搜索'],
    type: 'radio',
  },
  {
    topic: '电子表格支持制作多sheet页报表，以下说法正确的是？',
  ...
  },
  {
    topic: '电子表格切换参数刷新设置不包含以下哪个设置？',
    answer: 'D',
    answer_arr: ['A.自动刷新', 'B.手动刷新', 'C.局部刷新', 'D.打开只刷表样'],
    type: 'radio',
  },
  {
    topic:
  ...
  },
  {
    topic:
      '当我们在科目余额表中筛选出2022年10月份的数据后，想要查看该月份下某个科目的账簿时，我们可以点击“科目名称”来联查到总账表，此时需要设置什么字段作为传参值？',
    answer: 'C',
    answer_arr: ['A.月份', 'B.科目名称', 'C.月份和科目名称', 'D.以上都可以'],
    type: 'radio',
  },
  {
    topic:
  ...
  },
  {
    ...
    answer: 'D',
    answer_arr: [
      'A.查看堆栈信息，找到Causedby的部分，复制后在FAQ文档上进行搜索查找解决方法',
      'B.导出系统日志，找到Causedby的部分，复制后在FAQ文档上进行搜索查找解决方法',
      'C.将系统日志、报错资源、现象截图等内容发给Smartbi官方寻找解决方法',
      'D.以上都可以',
    ],
    type: 'radio',
  ...
  {
    topic: '电子表格提供了字段的父格设置，以下哪些是父格配置中的选项？',
    answer: 'AD',
  ...
  {
    topic: '电子表格的设计器界面我们可以分为哪几块区域？',
    answer: 'ABC',
    answer_arr: ['A.工具栏', 'B.报表设计区', 'C.数据集面板', 'D.移动端设计区'],
    type: 'radio',
  },
  {
    topic: '电子表格在字段的单元格属性中，支持的分页属性包含哪些？',
  ...
  },
  {
    topic: 'Schema相关操作是指数据源Schema更多操作的一些功能操作，包含什么？',
    answer: 'ABC',
    answer_arr: ['A.同步Schema', 'B.修改Schema名称', 'C.删除', 'D.新增Schema'],
    type: 'radio',
  },
  {
    topic: '设置回写规则时，能够选择的回写内容类型有哪些？',
  ...
  {
    topic: '1.关系数据源只能单表同步，不能批量同步表。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '2.Excel数据源指将数据文件导入到高速缓存库或关系数据源。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '3.在数据模型中，可以新建目录来存放字段，且该目录下的字段拥有层次结构。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '4.数据模型不能实现跨数据库查询。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '5.数据模型可以通过新建目录或者新建层次结构对维度字段进行归类划分，方便业务用户快速查找维度字段，提升分析效率。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '6.进行数据建模之后，可以对不需要的原始表以及字段进行隐藏，避免进行业务分析时出现不必要的干扰。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '7.在数据模型中可以对度量字段以及计算度量字段修改数据格式。 (1.0分)',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '8.交互式仪表盘支持以组件或者字段作为筛选器',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '9.透视分析中可以通过维度去关联筛选度量，点击“开启维度和度量的关联筛选”后，勾选所需维度，可快速过滤出其在数据模型中有表关联关系的度量。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '10.透视分析中，当业务数据集的原始维度和度量并不能满足数据分析的需求时，可以使用“计算列”功能对数据进行加工处理。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '11.即席查询主要用于清单明细数据的查询。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '12.即席查询只能实现字符串类型数据设置告警，不能实现数值类型数据设置告警。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '13.Web电子表格无法实现函数计算。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '14.现代的自助式分析模式，业务问题引出的开发流程，是以业务为中心、解决问题为导向，IT提供数据服务、分析工具；业务自助式探索分析。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '15.数据的展示表达中，从数据的展示效果以及表达信息的清晰度比较，图形优于表格，表格优于文字。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '16.连接了关系数据源后，需要选择数据库中的各类资源到系统中，数据库管理可以将数据库的什么资源添加到数据源下？',
    answer: 'D',
    answer_arr: ['A. 表', 'B. 视图', 'C. 存储过程', 'D. 以上都可以'],
    type: 'radio',
  },
  {
    topic:
      '17.数据源是指创建与业务数据库的连接，拿到数据进行分析，以下哪个不属于数据源连接的类型?',
    answer: 'B',
    answer_arr: [
      'A. 本地数据库',
      'B. 多源数据库',
  ...
  {
    topic: '18.数据模型中，对度量字段不可修改的属性是？ ',
    answer: 'C',
    answer_arr: ['A. 别名', 'B. 数据格式', 'C. 名称', 'D. 汇总依据'],
    type: 'radio',
  },
  {
    topic: '19.在数据模型中预览数据，默认查询多少条数据？ ',
    answer: 'B',
    answer_arr: ['A. 50', 'B. 100', 'C. 500', 'D. 1000'],
    type: 'radio',
  },
  {
    topic: '20.数据模型的能力是？ ',
  ...
  {
    topic:
      '21.业务人员使用数据模型创建子查询时，如果只想要数据源表的部分列数据可以使用什么子查询？',
    answer: 'B',
    answer_arr: [
      'A. 数据源表',
      'B. 可视化SQL查询',
  ...
  {
    topic:
      '23.数据模型中的地理维度字段，为后续能在仪表盘中正常进行地图分析，需要在模型中做什么操作？',
    answer: 'C',
    answer_arr: [
      'A. 在地理维度字段右键标记地位维度-无',
      'B. 在地理维度字段右键生成时间层次',
  ...
  {
    topic:
      '24.Web电子表格数据设置中，哪个设置项可以将数据列中相同内容的值进行合并？',
    answer: 'D',
    answer_arr: ['A. 合并', 'B. 列表', 'C. 汇总', 'D. 分组'],
    type: 'radio',
  },
  {
    topic: '25.进入即席查询界面，界面提示的创建流程是？ ',
    answer: 'D',
    answer_arr: [
      '    A. 添加过滤条件-选择输出字段-设置样式/完善报表-保存报表  ',
      '    B. 添加过滤条件-设置样式/完善报表-选择输出字段-保存报表  ',
  ...
  {
    topic:
      '26.交互式仪表盘中已经制作好的图表，如果想要换一种图表类型的话，应该怎么做？',
    answer: 'C',
    answer_arr: [
      'A. 将原来的图表删除，重建创建一个可视化图表',
      'B. 将原来的图表复制粘贴出一个新图表',
      'C. 在原来的图表上点击变换类型进行图表类型的更改',
      'D. 整个仪表盘删除，重新建一个',
    ],
    type: 'radio',
  },
  {
    topic:
      '27.交互式仪表盘中通过标线实现对图形数据实现预警效果，以下描述正确的是？',
    answer: 'A',
    answer_arr: [
      '    A. 根据不同的标线值类型，可分为 字段计算值 和 固定值    两种标线类型。  ',
      '    B. 根据预警效果的不同，可分为文字和背景两种预警效果  ',
      '    C. 根据预警效果的不同，可分为文字和图标集两种预警效果  ',
      '    D. 根据不同的标线值类型，可分为 动态值 和 固定值    两种标线类型。  ',
    ],
    type: 'radio',
  },
  {
    topic:
      '28.透视分析想要实现时间计算，必须保证行区/列区/过滤条件区中有什么字段？',
    answer: 'B',
    answer_arr: [
      'A. 普通维度字段',
      'B. 时间维度字段',
  ...
  {
    topic:
      '30.交互式仪表盘的条件格式是用于实现告警的功能，具体使用是通过对字段设置规则实现的，以下关于支持条件格式的字段说法正确的是？',
    answer: 'C',
    answer_arr: [
      'A. 只支持维度字段',
      'B. 只支持度量字段',
  ...
  {
    topic:
      '32.交互式仪表盘中数据太多如柱子展现太多，如何设置来实现自由调整显示区域，使数据查看更清晰、更灵活？',
    answer: 'B',
    answer_arr: ['A. Tab页', 'B. 缩略轴', 'C. 输出行设置', 'D. 排序设置'],
    type: 'radio',
  },
  {
    topic: '33.在即席查询中，可以将度量字段的数据格式改为什么类型？ ',
    answer: 'D',
  ...
  {
    topic:
      '34.想要标识出客户的不同阶段，可以制定不同的营销活动，如新产品推广、优惠券和促销活动等，可以使用哪个分析模型？',
    answer: 'B',
    answer_arr: [
      'A. 购物篮分析模型',
      'B. 客户生命周期模型',
  ...
  {
    topic:
      '36.想要将本地的数据文件导入到数据库中，Smartbi具体支持接入的数据库有哪些？',
    answer: 'AD',
    answer_arr: [
      'A. 关系数据库（RDBMS）',
      'B. 多维数据库（OLAP)',
  ...
  {
    topic: '39.设置数据模型的表间关系时，可供选择的表关系类型有哪些？ ',
    answer: 'ABC',
    answer_arr: ['A. 一对多', 'B. 多对一', 'C. 一对一', 'D. 多对多'],
    type: 'radio',
  },
  {
    topic:
      '40.数据模型提供强大的计算能力，当数据库表的维度、度量数据不足以支撑我们进行分析时，我们可以通过自定义计算得到我们需要的数据，以下哪些是数据模型提供的自定义计算功能？',
    answer: 'ABCD',
    answer_arr: [
      'A. 新建分组字段',
      'B. 新建计算列',
  ...
  {
    topic:
      '41.如果柱图的柱子数量太多，可以使用什么方式提高图形的可看性？ (3.0分)',
    answer: 'ABC',
    answer_arr: [
      'A. 增加缩略轴',
      'B. 设置排序并减少输出行数',
  ...
  {
    topic: '42.通过哪些方式可以实现交互式仪表盘的交互设计 ',
    answer: 'ABCD',
    answer_arr: ['A. 组件筛选', 'B. 组件联动', 'C. 组件下钻', 'D. 组件跳转'],
    type: 'radio',
  },
  {
    topic: '43.Web电子表格数据集面板支持哪种数据集 ',
    answer: 'AB',
    answer_arr: ['A. SQL查询', 'B. 模型查询', 'C. 原生SQL查询', 'D. 业务主题'],
    type: 'radio',
  },
  {
    topic:
      '44.为了让数据查询有更多的灵活性，即席查询支持在数据模型和数据源中自定义维度，包含？',
    answer: 'BC',
    answer_arr: [
      'A. 新建命名集',
      'B. 新建计算列',
  ...
  {
    topic: '45.交互式仪表盘的表格组件可以实现的条件格式有哪几种？ ',
    answer: 'ABC',
    answer_arr: ['A. 文字', 'B. 背景', 'C. 图标集', 'D. 数据条'],
    type: 'radio',
  },
  {
    topic:
      '46.交互式仪表盘中通过标线实现图形的预警效果，其中可以通过字段计算值动态实现标线，以下是支持的字段计算值类型的是？',
    answer: 'ABD',
    answer_arr: [
      'A. 最大值、最小值',
      'B. 中位数、平均值',
  ...
  {
    topic: '47.透视分析中，合计行的显示位置有哪些可以选择？ ',
    answer: 'ABCD',
    answer_arr: ['A. 顶部', 'B. 左侧', 'C. 底部', 'D. 右侧'],
    type: 'radio',
  },
  {
    topic: '48.透视分析综合了哪些数据分析方法的进行数据分析？ ',
    answer: 'ABCD',
    answer_arr: [
      'A. 排序法',
      'B. 交叉法',
  ...
  {
    topic: '49.即席查询能够选择的数据来源有哪些？ ',
    answer: 'AC',
    answer_arr: ['A. 数据源表', 'B. 业务主题', 'C. 数据模型', 'D. 透视分析'],
    type: 'radio',
  },
  {
    topic: '50.SWOT分析方法是从哪四象限进行分析？ ',
    answer: 'ABCE',
    answer_arr: [
      'A. 优势',
      'B. 劣势',
  ...
  {
    topic: '3.在数据模型中可以通过创建计算度量的方式实现时间计算。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '6.数据模型实现时间层次结构是在日期字段右键选择创建时间层次结构',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '7.数据模型创建层次结构是用于在仪表盘中可以实现层次下钻',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '8.透视分析中，当业务数据集的原始维度和度量并不能满足数据分析的需求时，可以使用“计算列”功能对数据进行加工处理。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '9.在交互式仪表盘中无法实现时间计算',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '10.交互式仪表盘支持以组件或者字段作为筛选器',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '11.交互式仪表盘如果需要统一设计风格，可以在“主题”中进行相应设置',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '12.交互式仪表盘的指标看板或文本组件可以实现的条件格式类型有文字与图标集，不支持背景',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '13.Web电子表格支持单元格数据过滤。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '14.杜邦分析模型可以帮助企业识别影响其绩效的主要财务因素。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '15.占比构成、多类别部分到整体、成分分布构成等属于图形选择决策树中构成系列的图形特性。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  ...
  {
    topic: '17.关系数据库的数据库管理不可以添加以下什么资源? ',
    answer: 'D',
    answer_arr: ['A. 表', 'B. 视图', 'C. 存储过程', 'D. 触发器'],
    type: 'radio',
  },
  {
    topic:
      '18.数据模型中的地理维度字段，为后续能在仪表盘中正常进行地图分析，需要在模型中做什么操作？',
    answer: 'C',
    answer_arr: [
      'A. 在地理维度字段右键标记地位维度-无',
      'B. 在地理维度字段右键生成时间层次',
  ...
  {
    topic:
      '19.业务人员使用数据模型创建子查询时，如果只想要数据源表的部分列数据可以使用什么子查询？',
    answer: 'B',
    answer_arr: [
      'A. 数据源表',
      'B. 可视化SQL查询',
  ...
  {
    topic:
      '20.业务人员存在一些线下数据需要合并分析，在数据模型中可以使用什么子查询进行模型的构建？',
    answer: 'A',
    answer_arr: [
      'A. 导入文件',
      'B. 可视化SQL查询',
  ...
  {
    topic:
      '23.某技术人员习惯写SQL取数，在数据模型中可以使用什么子查询进行模型的构建？',
    answer: 'D',
    answer_arr: [
      'A. 可视化SQL查询',
      'B. 数据源表',
  ...
  {
    topic:
      '24.透视分析想要实现时间计算，必须保证行区/列区/过滤条件区中有什么字段？',
    answer: 'B',
    answer_arr: [
      'A. 普通维度字段',
      'B. 时间维度字段',
  ...
  {
    topic:
      '25.交互式仪表盘中数据太多如柱子展现太多，如何设置来实现自由调整显示区域，使数据查看更清晰、更灵活？',
    answer: 'B',
    answer_arr: ['A. Tab页', 'B. 缩略轴', 'C. 输出行设置', 'D. 排序设置'],
    type: 'radio',
  },
  ...
  {
    topic:
      '27.哪个选项用于对交互式仪表盘中所有组件的样式批量进行设计，包括背景、边框、标题。',
    answer: 'B',
    answer_arr: [
      'A. 主题区仪表盘',
      'B. 主题区组件',
  ...
  {
    topic:
      '28.用户拿到一张炫酷的仪表盘演示模板，想要将数据替换成自己的业务数据查看效果，可以通过哪个功能完成',
    answer: 'D',
    answer_arr: ['A. 设计库', 'B. 模板', 'C. 资源', 'D. 替换数据来源'],
    type: 'radio',
  },
  {
    topic: '29.在即席查询中，设置条件格式的位置在哪里？ ',
  ...
  {
    topic: '30.在即席查询中，可以将度量字段的数据格式改为什么类型？ ',
    answer: 'D',
    answer_arr: ['A. 整型', 'B. 浮点型', 'C. 百分比', 'D. 以上都是'],
    type: 'radio',
  },
  {
    topic:
      '31.某用户有中国式复杂报表的需求，但公司内部要求严格，无法在机器上安装外部插件，可推荐Smartbi的什么功能模块给此用户实现他的需求？',
    answer: 'B',
    answer_arr: [
      'A. 电子表格',
      'B. Web电子表格',
  ...
  {
    topic:
      '32.交互式仪表盘的条件格式是用于实现告警的功能，具体使用是通过对字段设置规则实现的，以下关于支持条件格式的字段说法正确的是？',
    answer: 'C',
    answer_arr: [
      'A. 只支持维度字段',
      'B. 只支持度量字段',
  ...
  {
    topic:
      '33.如果你想实现管理驾驶舱、KPI，并且项目要求周期短，希望业务人员也能快速实现，可使用Smartbi功能是',
    answer: 'D',
    answer_arr: [
      'A. 电子表格',
      'B. 即席查询',
  ...
  {
    topic: '35.在统计学中，数据分析的核心是什么？ ',
    answer: 'D',
    answer_arr: ['A. 工具', 'B. 技术', 'C. 人员', 'D. 数据'],
    type: 'radio',
  },
  {
    topic: '36.关系数据源允许对Schema进行操作，以下哪些说法是正确的？ ',
    answer: 'BD',
    answer_arr: [
      'A. 关系数据源不允许存在多个Schema',
      '    B. 执行同步Schema后，会把此Schema下的所有表都会添加进来  ',
  ...
  {
    topic: '37.数据模型中，包含以下哪一种子查询时，必须使用抽取模式？ ',
    answer: 'ABCD',
    answer_arr: [
      'A. 导入文件',
      'B. 脚本查询',
  ...
  {
    topic:
      '41.交互式仪表盘的布局工具包括哪些功能，实现大屏精准排布，组件快速定位。',
    answer: 'ABCD',
    answer_arr: [
      'A. 鹰眼、画布缩放',
      'B. 参考线、网格线、智能参考线',
  ...
  {
    topic: '42.交互式仪表盘的哪些组件类型可以实现条件格式？ ',
    answer: 'ABC',
    answer_arr: [
      'A. 明细表、汇总表、交叉表',
      'B. 指标卡',
  ...
  {
    topic:
      '44.在透视分析中，可以对过滤的结果数据，作进一步筛选过滤，这种过滤的方式有哪些？',
    answer: 'AC',
    answer_arr: ['A. 只保留', 'B. 只过滤', 'C. 排除', 'D. 不排除'],
    type: 'radio',
  },
  {
    topic: '45.以下是Web电子表格能支持的功能是？ ',
    answer: 'ABCD',
    answer_arr: ['A. 迷你图', 'B. 条件格式', 'C. 跳转规则', 'D. 参数过滤'],
    type: 'radio',
  },
  {
    topic: '46.通过哪些方式可以实现交互式仪表盘的交互设计 ',
    answer: 'ABCD',
    answer_arr: ['A. 组件筛选', 'B. 组件联动', 'C. 组件下钻', 'D. 组件跳转'],
    type: 'radio',
  },
  {
    topic:
      '47.交互式仪表盘中通过标线实现图形的预警效果，其中可以通过字段计算值动态实现标线，以下是支持的字段计算值类型的是？',
    answer: 'ABD',
    answer_arr: [
      'A. 最大值、最小值',
      'B. 中位数、平均值',
  ...
  {
    topic:
      '48.为了让数据查询有更多的灵活性，即席查询支持在数据模型和数据源中自定义维度，包含？',
    answer: 'BC',
    answer_arr: [
      'A. 新建命名集',
      'B. 新建计算列',
  ...
  {
    topic: '49.透视分析综合了哪些数据分析方法的进行数据分析？ ',
    answer: 'ABCD',
    answer_arr: [
      'A. 排序法',
      'B. 交叉法',
  ...
  {
    topic: '50.在BI平台中，实现未分组统计表，可通过哪些工具实现？ ',
    answer: 'BCD',
    answer_arr: [
      'A. 透视分析',
      'B. 交互式仪表盘',
  ...
  {
    topic: '1.Excel数据源指将数据文件导入到高速缓存库或关系数据源。 ',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '2.数据源某张表在数据库中删除了一个字段，在系统同步表之后，对已经引用了该表字段的查询和报表不影响。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '3.在数据模型中可以对度量字段以及计算度量字段修改数据格式。 (1.0分)',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '4.进行数据建模之后，可以对不需要的原始表以及字段进行隐藏，避免进行业务分析时出现不必要的干扰。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '5.数据模型不能实现跨数据库查询。 ',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '6.数据模型可以通过新建目录或者新建层次结构对维度字段进行归类划分，方便业务用户快速查找维度字段，提升分析效率。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '7.在数据模型中可以通过创建计算度量的方式实现时间计算。 ',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '8.Web电子表格无法实现点击列头自动排序效果。 ',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '9.即席查询能够进行时间计算。 ',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '10.即席查询只能实现字符串类型数据设置告警，不能实现数值类型数据设置告警。',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '11.透视分析上创建的分组字段属于报表私有，不能和其它报表共用。 (1.0分)',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic: '12.Web电子表格无法实现函数计算。 ',
    answer: '错误',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '13.交互式仪表盘的指标看板或文本组件可以实现的条件格式类型有文字与图标集，不支持背景',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '14.占比构成、多类别部分到整体、成分分布构成等属于图形选择决策树中构成系列的图形特性。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '15.统计学是一门通过收集、处理、分析、解释数据并从数据中得出结论的科学。',
    answer: '正确',
    answer_arr: [],
    type: 'determine',
  },
  {
    topic:
      '16.连接关系数据源时，在连接配置界面需要对连接的字符串进行什么修改？',
    answer: 'D',
    answer_arr: [
      'A. 数据库ip',
      'B. 数据库端口',
  ...
  {
    topic:
      '17.连接了关系数据源后，需要选择数据库中的各类资源到系统中，数据库管理可以将数据库的什么资源添加到数据源下？',
    answer: 'D',
    answer_arr: ['A. 表', 'B. 视图', 'C. 存储过程', 'D. 以上都可以'],
    type: 'radio',
  },
  {
    topic: '18.在数据模型中预览数据，默认查询多少条数据？ ',
    answer: 'B',
    answer_arr: ['A. 50', 'B. 100', 'C. 500', 'D. 1000'],
    type: 'radio',
  },
  ...
  {
    topic:
      '21.业务人员存在一些线下数据需要合并分析，在数据模型中可以使用什么子查询进行模型的构建？',
    answer: 'A',
    answer_arr: [
      'A. 导入文件',
      'B. 可视化SQL查询',
  ...
  {
    topic:
      '22.数据模型中的地理维度字段，为后续能在仪表盘中正常进行地图分析，需要在模型中做什么操作？',
    answer: 'C',
    answer_arr: [
      'A. 在地理维度字段右键标记地位维度-无',
      'B. 在地理维度字段右键生成时间层次',
  ...
  {
    topic:
      '23.业务需要分析数据，但相关数据分散在不同地方，以不同形式存在，可以使用什么功能来解决？',
    answer: 'B',
    answer_arr: ['A. 业务主题', 'B. 数据模型', 'C. 自助ETL', 'D. 指标模型'],
    type: 'radio',
  },
  {
    topic: '24.交互式仪表盘中对图形数据实现预警使用的是什么功能？ ',
    answer: 'D',
    answer_arr: ['A. 文字', 'B. 背景', 'C. 图标集', 'D. 标线'],
    type: 'radio',
  },
  {
    topic:
      '25.[align=left][font=思源黑体Normal]查询明细数据是最为常见的业务需求，业务人员一般可以使用[/font]Smartbi[font=思源黑体Normal]平台哪项功能？[/font][/align] ',
    answer: 'A',
    answer_arr: [
      'A. 即席查询',
      'B. 透视分析',
  ...
  {
    topic:
      '26.交互式仪表盘的条件格式是用于实现告警的功能，具体使用是通过对字段设置规则实现的，以下关于支持条件格式的字段说法正确的是？',
    answer: 'C',
    answer_arr: [
      'A. 只支持维度字段',
      'B. 只支持度量字段',
  ...
  {
    topic:
      '27.制作交互式仪表盘的过程中，如果出现某一步操作失误想要回退到上一步或恢复到下一步时，可以如何操作',
    answer: 'A',
    answer_arr: [
      'A. 点击撤销/重做，可快速撤销或恢复30步以内的操作',
      'B. 点击回退/前进',
  ...
  {
    topic:
      '28.Web电子表格数据设置中，哪个设置项可以将数据列中相同内容的值进行合并？',
    answer: 'D',
    answer_arr: ['A. 合并', 'B. 列表', 'C. 汇总', 'D. 分组'],
    type: 'radio',
  },
  {
    topic: '29.如果想要看一段时间的趋势，使用哪个图形呈现效果最佳？ ',
    answer: 'B',
    answer_arr: ['A. 饼图', 'B. 线图', 'C. 雷达图', 'D. 热力图'],
    type: 'radio',
  },
  {
    topic: '30.透视分析中，新建分组字段时，“分组设置”有几种方式？ ',
    answer: 'D',
    answer_arr: [
      'A. 添加分组',
      'B. 合并成一项',
  ...
  {
    topic: '31.透视分析的表格风格，有哪些可以进行选择？ ',
    answer: 'D',
    answer_arr: ['A. 表格', 'B. 无边框', 'C. 斑马线', 'D. 以上都可以'],
    type: 'radio',
  },
  {
    topic: '32.透视分析新建分组字段时，能够选择什么字段？ ',
    answer: 'A',
    answer_arr: [
      'A. 目录下的字段',
      'B. 层次结构下的字段',
  ...
  {
    topic:
      '33.交互式仪表盘中已经制作好的图表，如果想要换一种图表类型的话，应该怎么做？',
    answer: 'C',
    answer_arr: [
      'A. 将原来的图表删除，重建创建一个可视化图表',
      'B. 将原来的图表复制粘贴出一个新图表',
  ...
  {
    topic: '34.在RFM模型中，最近一次购买日期越远的客户一般被认为？ ',
    answer: 'C',
    answer_arr: ['A. 重要客户', 'B. 潜在客户', 'C. 流失客户', 'D. 忠诚客户'],
    type: 'radio',
  },
  {
    topic:
      '35.数据分析微观方法中，分析时可以按类型、结构、时间阶段等维度进行分组，观察分组后的数据特征，从特征中洞察信息，属于什么分析方法',
    answer: 'D',
    answer_arr: ['A. 对比法', 'B. 降维法', 'C. 增维法', 'D. 分组法'],
    type: 'radio',
  },
  {
    topic:
  ...
  {
    topic: '38.数据模型中，包含以下哪一种子查询时，必须使用抽取模式？ ',
    answer: 'ABCD',
    answer_arr: [
      'A. 导入文件',
      'B. 脚本查询',
  ...
  {
    topic: '41.Web电子表格支持的报表数据结果导出方式有哪些 ',
    answer: 'BCD',
    answer_arr: ['A. Word', 'B. Excel', 'C. PNG', 'D. PDF'],
    type: 'radio',
  },
  {
    topic: '42.以下是Web电子表格能支持的功能是？ ',
    answer: 'ABCD',
    answer_arr: ['A. 迷你图', 'B. 条件格式', 'C. 跳转规则', 'D. 参数过滤'],
    type: 'radio',
  },
  {
    topic:
      '43.即席查询支持将报表结果进行导出，导出的文件格式可以选择哪些类型？',
    answer: 'BC',
    answer_arr: ['A. TXT', 'B. CSV', 'C. EXCEL', 'D. PDF'],
    type: 'radio',
  },
  {
    topic: '44.即席查询能够选择的数据来源有哪些？ ',
    answer: 'AC',
    answer_arr: ['A. 数据源表', 'B. 业务主题', 'C. 数据模型', 'D. 透视分析'],
    type: 'radio',
  },
  {
    topic: '45.透视分析的数据面板能够做哪些操作？ ',
    answer: 'ABCD',
    answer_arr: [
      'A. 选择数据来源',
      'B. 创建分组字段',
  ...
  {
    topic:
      '46.为了让数据查询有更多的灵活性，即席查询支持在数据模型和数据源中自定义维度，包含？',
    answer: 'BC',
    answer_arr: [
      'A. 新建命名集',
      'B. 新建计算列',
  ...
  {
    topic: '47.通过哪些方式可以实现交互式仪表盘的交互设计 ',
    answer: 'ABCD',
    answer_arr: ['A. 组件筛选', 'B. 组件联动', 'C. 组件下钻', 'D. 组件跳转'],
    type: 'radio',
  },
  {
    topic:
      '48.交互式仪表盘的布局工具包括哪些功能，实现大屏精准排布，组件快速定位。',
    answer: 'ABCD',
    answer_arr: [
      'A. 鹰眼、画布缩放',
      'B. 参考线、网格线、智能参考线',
  ...
  {
    topic: '49.交互式仪表盘的表格组件可以实现的条件格式有哪几种？ ',
    answer: 'ABC',
    answer_arr: ['A. 文字', 'B. 背景', 'C. 图标集', 'D. 数据条'],
    type: 'radio',
  },
  {
    topic: '50.在数据分析中，用于查看序列数据或趋势数据的图形类型可选择哪些？',
    answer: 'ABCD',
